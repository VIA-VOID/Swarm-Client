...
Shader "Polyart/Dreamscape Waterfall"
{
	Properties
	{
		...
		[ASEBegin]_LineScaleWidth("Line Scale Width", Float) = 0
		...
		[ASEEnd]_DisplacementMovement("Displacement Movement", Vector) = (0,3,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord142 = v.texcoord.xy * temp_cast_0 + float2( 0,0 );
				float2 panner143 = ( 1.0 * _Time.y * _DisplacementMovement + texCoord142);
				...
				float3 vertexValue = vDisplacement136.rgb;
						 ...
						 ) : SV_Target
			{
				...
				float screenDepth105 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth105 = abs( ( screenDepth105 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _ColorDepthFade ) );
				float4 lerpResult109 = lerp( _ColorShallow , _ColorDeep , saturate( distanceDepth105 ));
				float2 temp_cast_0 = (_WaveTiling02).xx;
				float2 texCoord142 = IN.ase_texcoord8.xy * temp_cast_0 + float2( 0,0 );
				float2 panner143 = ( 1.0 * _Time.y * _DisplacementMovement + texCoord142);
				...
				float2 texCoord42 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord17 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult26 = (float2(( _LineScaleWidth * texCoord17.x ) , pow( texCoord17.y , _LineAcceleration )));
				float2 vMovementLines112 = appendResult26;
				float2 break27 = vMovementLines112;
				float2 appendResult30 = (float2(( _Line01ScaleX * break27.x ) , ( ( break27.y - ( _TimeParameters.x * _Line01Speed ) ) * _Line01ScaleY )));
				float4 vLine01113 = tex2D( _WaterLines, appendResult30 );
				float2 break55 = vMovementLines112;
				float2 appendResult61 = (float2(( _Line02ScaleX * break55.x ) , ( ( break55.y - ( _TimeParameters.x * _Line02Speed ) ) * _Line02ScaleY )));
				float4 vLine02120 = tex2D( _WaterLines, appendResult61 );
				float4 vLinesCombined122 = floor( saturate( ( saturate( ( ( texCoord42.y * _LineUVFade ) + ( ( vLine01113 * vLine02120 ) * 2.0 ) ) ) + ( 1.0 - _LineTreshold ) ) ) );
				float4 lerpResult124 = lerp( _LineColor , vDepthColor110 , vLinesCombined122);
				
				float2 temp_cast_2 = (_WaveTiling01).xx;
				float2 texCoord72 = IN.ase_texcoord8.xy * temp_cast_2 + float2( 0,0 );
				float2 panner76 = ( 1.0 * _Time.y * float2( 0,0.75 ) + texCoord72);
				float3 unpack89 = UnpackNormalScale( tex2D( _NormalWave, panner76 ), _WaveNormalIntensity );
				unpack89.z = lerp( 1, unpack89.z, saturate(_WaveNormalIntensity) );
				float3 vNormal91 = unpack89;
				

				float3 BaseColor = lerpResult124.rgb;
				float3 Normal = vNormal91;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float2 temp_cast_0 = (_WaveTiling02).xx;
				float2 texCoord142 = v.ase_texcoord.xy * temp_cast_0 + float2( 0,0 );
				float2 panner143 = ( 1.0 * _Time.y * _DisplacementMovement + texCoord142);
				float4 vDisplacement136 = ( saturate( tex2Dlod( _Displace1, float4( panner143, 0, 0.0) ) ) * _DisplaceStrength );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_cast_0 = (_WaveTiling02).xx;
				float2 texCoord142 = v.texcoord0.xy * temp_cast_0 + float2( 0,0 );
				float2 panner143 = ( 1.0 * _Time.y * _DisplacementMovement + texCoord142);
				float4 vDisplacement136 = ( saturate( tex2Dlod( _Displace1, float4( panner143, 0, 0.0) ) ) * _DisplaceStrength );
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 lerpResult109 = lerp( _ColorShallow , _ColorDeep , saturate( distanceDepth105 ));
				float2 temp_cast_0 = (_WaveTiling02).xx;
				float2 texCoord142 = IN.ase_texcoord5.xy * temp_cast_0 + float2( 0,0 );
				float2 panner143 = ( 1.0 * _Time.y * _DisplacementMovement + texCoord142);
				float4 vDisplacement136 = ( saturate( tex2D( _Displace1, panner143 ) ) * _DisplaceStrength );
				float4 lerpResult140 = lerp( lerpResult109 , ( lerpResult109 + float4( 0.4414383,0.5903998,0.6037736,1 ) ) , vDisplacement136);
				float4 vDepthColor110 = lerpResult140;
				float2 texCoord42 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord17 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult26 = (float2(( _LineScaleWidth * texCoord17.x ) , pow( texCoord17.y , _LineAcceleration )));
				float2 vMovementLines112 = appendResult26;
				float2 break27 = vMovementLines112;
				float2 appendResult30 = (float2(( _Line01ScaleX * break27.x ) , ( ( break27.y - ( _TimeParameters.x * _Line01Speed ) ) * _Line01ScaleY )));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 lerpResult109 = lerp( _ColorShallow , _ColorDeep , saturate( distanceDepth105 ));
				float2 temp_cast_0 = (_WaveTiling02).xx;
				float2 texCoord142 = IN.ase_texcoord3.xy * temp_cast_0 + float2( 0,0 );
				float2 panner143 = ( 1.0 * _Time.y * _DisplacementMovement + texCoord142);
				float4 vDisplacement136 = ( saturate( tex2D( _Displace1, panner143 ) ) * _DisplaceStrength );
				float4 lerpResult140 = lerp( lerpResult109 , ( lerpResult109 + float4( 0.4414383,0.5903998,0.6037736,1 ) ) , vDisplacement136);
				float4 vDepthColor110 = lerpResult140;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord72 = IN.ase_texcoord4.xy * temp_cast_0 + float2( 0,0 );
				float2 panner76 = ( 1.0 * _Time.y * float2( 0,0.75 ) + texCoord72);
				float3 unpack89 = UnpackNormalScale( tex2D( _NormalWave, panner76 ), _WaveNormalIntensity );
				unpack89.z = lerp( 1, unpack89.z, saturate(_WaveNormalIntensity) );
				float3 vNormal91 = unpack89;
...
Node;AmplifyShaderEditor.GetLocalVarNode;137;-828.5879,408.8264;Inherit;False;136;vDisplacement;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;148;-491.0047,124.6019;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;149;-491.0047,124.6019;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Polyart/Dreamscape Waterfall;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;150;-491.0047,124.6019;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;151;-491.0047,124.6019;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;152;-491.0047,124.6019;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;153;-491.0047,124.6019;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;154;-491.0047,124.6019;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;155;-491.0047,124.6019;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;156;-491.0047,124.6019;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;157;-491.0047,124.6019;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
...
WireConnection;149;1;93;0
WireConnection;149;4;128;0
WireConnection;149;8;137;0
ASEEND*/
//CHKSM=98E8BC32EEA926A5E6BF536DAD5DBE21878F9FC2